---
name: security-audit
description: Run a structured security pass over the native-messaging origin validation, yt-dlp subprocess invocation, and downloaded-file path handling in this project. Trigger phrases- "revision de seguridad", "audita el native host", "chequea inyeccion de comandos", "security review".
---
...
## Scope: the three named risk surfaces
...
1. Read `specs/03-security-spec.md` in full — it is the checklist, this
   ...
   time.
2. For each of the three surfaces above, read the named files and grep for
   the specific patterns called out.
